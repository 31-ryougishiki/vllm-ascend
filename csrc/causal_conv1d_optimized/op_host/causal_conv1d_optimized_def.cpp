...
/*!
 * \file causal_conv1d_optimized_def.cpp
 * \brief Op definition for CausalConv1dOptimized
 */
#include "register/op_def_registry.h"

namespace ops {

class CausalConv1dOptimized : public OpDef {
public:
    explicit CausalConv1dOptimized(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
