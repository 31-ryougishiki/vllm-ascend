...
/*!
 * \file causal_conv1d_optimized_tiling.cpp
 * \brief Tiling strategy for CausalConv1dOptimized
 */
...
#include "math_util.h"
#include "causal_conv1d_optimized_tiling.h"
#include "../op_kernel/causal_conv1d_optimized_tiling_key.h"
...
{
    // Use same tiling candidates as original causal_conv1d
...
{
    auto compileInfoPtr = context->GetCompileInfo<CausalConv1dOptimizedCompileInfo>();
...
static ge::graphStatus GetShapeDtypeInfo(gert::TilingContext* context, CausalConv1dOptimizedTilingData& tiling)
{
...
static ge::graphStatus CausalConv1dOptimizedTilingFunc(gert::TilingContext* context)
{
    uint64_t ubSize;
    uint32_t coreNum;
    ...
    CausalConv1dOptimizedTilingData tilingData;
    ...
    const uint64_t tilingKey = GET_TPL_TILING_KEY(CAUSAL_CONV1D_OPTIMIZED_TPL_SCH_MODE_DEFAULT);
...
static ge::graphStatus TilingParseForCausalConv1dOptimized(gert::TilingParseContext* context)
{
    auto platformInfoPtr = context->GetPlatformInfo();
    OP_CHECK_NULL_WITH_CONTEXT(context, platformInfoPtr);
    auto compileInfoPtr = context->GetCompiledInfo<CausalConv1dOptimizedCompileInfo>();
...
IMPL_OP_OPTILING(CausalConv1dOptimized)
    .Tiling(CausalConv1dOptimizedTilingFunc)
    .TilingParse<CausalConv1dOptimizedCompileInfo>(TilingParseForCausalConv1dOptimized);
} // namespace optiling